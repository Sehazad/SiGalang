...
@section('title', 'Login Admin - SIGALANG FC')
    ...
    <div class="w-full max-w-md relative z-10">
        <div class="glass-dark rounded-3xl shadow-2xl p-8 sm:p-10 space-y-8">
            ...
            <div class="text-center space-y-3">
                ...
                <h1 class="text-3xl font-extrabold text-white tracking-tight">Login Admin</h1>
                <p class="text-sm text-slate-400 font-medium">Halaman akses khusus Admin & Karyawan</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login.process') }}" class="space-y-6">
                ...
                <div class="space-y-5">
                    {{-- No HP --}}
                    <div class="space-y-2">
                        <label for="no_hp" class="block text-sm font-bold text-slate-300">Nomor Handphone</label>
                        <div class="relative">
            ...
            <div class="pt-6 text-center border-t border-slate-900">
                <div class="flex items-center justify-center gap-4 text-sm font-bold">
                    <a href="{{ route('login') }}" class="text-slate-400 hover:text-brand transition-colors">Login User</a>
                </div>
            </div>
            ...
            <div class="bg-amber-500/5 border border-amber-500/10 rounded-2xl px-5 py-4 text-sm text-amber-300 flex items-start gap-3 mt-6">
                ...
                <p class="leading-relaxed">Halaman ini hanya untuk <strong>Admin</strong> dan <strong>Karyawan</strong>. Silakan gunakan kredensial yang valid.</p>
            </div>
        </div>
    </div>
</div>
